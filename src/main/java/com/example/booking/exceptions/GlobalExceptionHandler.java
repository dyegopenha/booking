...
public class GlobalExceptionHandler {
   ...
   public ResponseEntity<ErrorMessageResponse> handleApiException(Exception ex,
         WebRequest request) {
      ApiException apiException = (ApiException) ex;

      int status = apiException.getStatus().value();
   ...
   public static class ErrorMessageResponse {
      ...
      private ErrorMessageResponse(ApiException ex) {
